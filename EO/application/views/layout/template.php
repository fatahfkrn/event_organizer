...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <link
      rel="shortcut icon"
      href="<?= base_url('template/assets/images/favicon.png')?> "
      type="image/x-icon"
    />
    <link rel="stylesheet" href="<?= base_url("template/assets/css/animate.css")?>"/>
    <link rel="stylesheet" href="<?= base_url("template/assets/css/tailwind.css")?> "/>
        ...
        <div class="relative -mx-4 flex items-center justify-between">
          <div class="w-60 max-w-full px-4">
            <a href="index.html" class="navbar-logo block w-full py-5">
              <img
                src="<?= base_url("template/assets/images/logo/logo-white.svg")?>"
                alt="logo"
        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            ...
            >
              ...
              <div class="wow fadeInUp text-center" data-wow-delay=".3s">
                <img
                  src="<?= base_url("template/assets/images/hero/brand.svg")?>"
                  alt="image"
          ...
          <div class="w-full px-4">
            ...
            >
              <div class="mt-16">
                <img
                  src="<?= base_url("template/assets/images/hero/hero-image.jpg")?>"
                  alt="hero"
              ...
              >
                ...
                <div class="text-center">
                  <div class="relative z-10 inline-block">
                    <img
                      src="<?= base_url("template/assets/images/about/about-image.svg")?>"
                      alt="image"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="ud-testimonial-info flex items-center">
                ...
                >
                  <img
                    src="<?= base_url("template/assets/images/testimonials/author-01.png")?>"
                    alt="author"
                  />
                </div>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="ud-testimonial-info flex items-center">
                ...
                >
                  <img
                    src="<?= base_url("template/assets/images/testimonials/author-02.png")?>"
                    alt="author"
                  />
                </div>
                <div class="ud-testimonial-meta">
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="ud-testimonial-info flex items-center">
                ...
                >
                  <img
                    src="<?= base_url("template/assets/images/testimonials/author-03.png")?>"
                    alt="author"
                  />
                </div>
                <div class="ud-testimonial-meta">
            ...
            <div class="wow fadeInUp" data-wow-delay=".2s">
              ...
              <div class="ud-brands-logo flex flex-wrap items-center">
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  ...
                  >
                    <img
                      src="<?= base_url("template/assets/images/brands/tailgrids.svg")?>"
                      alt="tailgrids"
                ...
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  ...
                  >
                    <img
                      src="<?= base_url("template/assets/images/brands/ayroui.svg")?>"
                      alt="ayroui"
                      class="grayscale duration-300 hover:filter-none"
                    />
                  </a>
                ...
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  ...
                  >
                    <img
                      src="<?= base_url("template/assets/images/brands/uideck.svg")?>"
                      alt="uideck"
                      class="grayscale duration-300 hover:filter-none"
                    />
                  </a>
                ...
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  ...
                  >
                    <img
                      src="<?= base_url("template/assets/images/brands/graygrids.svg")?>"
                      alt="graygrids"
                      class="grayscale duration-300 hover:filter-none"
                    />
                  </a>
                ...
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  ...
                  >
                    <img
                      src="<?= base_url("template/assets/images/brands/lineicons.svg")?>"
                      alt="lineicons"
                      class="grayscale duration-300 hover:filter-none"
                    />
                  </a>
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".1s">
              ...
              >
                <img
                  src="<?= base_url("template/assets/images/team/team-01.png")?>"
                  alt="image"
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".15s">
              ...
              >
                <img
                  src="<?= base_url("template/assets/images/team/team-02.png")?>"
                  alt="image"
                  class="w-full rounded-full"
                />
                <span class="absolute top-0 left-0 z-[-1]">
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".2s">
              ...
              >
                <img
                  src="<?= base_url("template/assets/images/team/team-03.png")?>"
                  alt="image"
                  class="w-full rounded-full"
                />
                <span class="absolute top-0 left-0 z-[-1]">
    ...
    >
            ...
            <div class="mb-10 w-full">
              ...
              <ul class="flex flex-wrap items-center">
                <li>
                  ...
                  >
                    <img
                      src="<?= base_url("template/assets/images/footer/brands/tailgrids.svg")?>"
                      alt="tailgrids"
                    />
                  </a>
                </li>
                <li>
                  ...
                  >
                    <img
                      src="<?= base_url("template/assets/images/footer/brands/ayroui.svg")?>"
                      alt="ayroui"
                    />
                  </a>
                </li>
                <li>
                  ...
                  >
                    <img
                      src="<?= base_url("template/assets/images/footer/brands/ecommerce-html.svg")?>"
                      alt="ecommerce-html"
                    />
                  </a>
                </li>
                <li>
                  ...
                  >
                    <img
                      src="<?= base_url("template/assets/images/footer/brands/graygrids.svg")?>"
                      alt="graygrids"
                    />
                  </a>
                </li>
                <li>
                  ...
                  >
                    <img
                      src="<?= base_url("template/assets/images/footer/brands/lineicons.svg")?>"
                      alt="lineicons"
                    />
                  </a>
                </li>
                <li>
                  ...
                  >
                    <img
                      src="<?= base_url("template/assets/images/footer/brands/uideck.svg")?>"
                      alt="uideck"
                    />
                  </a>
                </li>
      ...
      <div>
        <span class="absolute left-0 top-0 z-[-1]">
          <img src="<?= base_url("template/assets/images/footer/shape-1.svg")?>" alt="" />
        </span>

        <span class="absolute bottom-0 right-0 z-[-1]">
          <img src="<?= base_url("template/assets/images/footer/shape-3.svg")?>" alt="" />
        </span>
